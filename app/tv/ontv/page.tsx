  ...
  const fetchTvShows = useCallback(async (pageNum: number, append = false) => {
    ...
    try {
      const params = new URLSearchParams({
        ...
        'air_date.lte': new Date().toISOString().split('T')[0], // shows currently airing or recently aired
      });
      ...
      if (startDate) params.set('first_air_date.gte', startDate);
      if (endDate) params.set('first_air_date.lte', endDate);
    ...
    <div className="w-full min-h-screen bg-zinc-950 text-white pt-[50px] lg:pt-[60px]">
      <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <aside className="bg-zinc-900 p-5 rounded-2xl border border-zinc-800 h-fit space-y-6">
          ...
          {/* Air Dates */}
          <div>
            <h3 className="font-semibold text-gray-300 mb-2">Air Date Range</h3>
        ...
        <main className="md:col-span-3">
          <h2 className="text-3xl font-bold mb-6">Currently On The Air</h2>
